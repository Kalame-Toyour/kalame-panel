...
const PurchaseAuthNotification: React.FC<PurchaseAuthNotificationProps> = ({ isVisible, onClose, onLogin }) => {
            ...
            <div className="relative bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 border border-blue-200/50 dark:border-blue-700/50 shadow-xl">
              ...
              <div className="mb-4">
                <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
                  برای خرید پکیج و استفاده از تمامی امکانات، 
              ...
              <div className="mb-6 space-y-2">
                <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                  ...
                  <span>دسترسی به تمامی پکیج‌ها</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                  <Sparkles className="w-4 h-4 text-blue-500" />
