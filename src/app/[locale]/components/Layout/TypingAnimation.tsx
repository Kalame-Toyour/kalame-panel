...
export const TypingAnimation = ({ texts }: TypingAnimationProps) => {
  ...
  return (
    ...
    <span className="mb-8 h-8 bg-gradient-to-l from-inherit to-cyan-100 bg-clip-text text-xl font-bold text-transparent dark:from-blue-400 dark:to-cyan-500 md:text-3xl">
      <TypeAnimation
        sequence={sequence}
        wrapper="span"
        speed={60}
