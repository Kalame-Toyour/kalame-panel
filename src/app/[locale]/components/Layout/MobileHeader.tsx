  ...
  return (
    <div className="flex items-center justify-between border-b border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900 md:hidden">
      <button
        ...
        className="rounded-lg p-2 font-bold text-primary transition-colors hover:bg-gray-100 dark:text-primary dark:hover:bg-gray-800"
      >
        <User size={32} />
      </button>
      ...
      <div className="relative">
        <img
          src="/kalame-logo.png"
          alt="logo"
          className="w-12 animate-[spin_2s_linear_infinite_paused] rounded-2xl transition-all duration-700 hover:rotate-[360deg] hover:scale-110 hover:animate-[spin_7s_linear_infinite_running]
